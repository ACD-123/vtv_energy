...
export const WhyVtvEnergy = ({ title, description, image }) => {
  return (
    <>
          ...
          <div className='row align-items-center'>
            <div className='col-lg-6 col-md-12 col-sm-12'>
              <div className='EnergyLeft'>
                <h2 className="WindText" style={{ fontFamily: "'Bebas Neue', 'Inter', sans-serif", fontSize: '3.5rem', color: '#00E5FF' }}>
                  {title || "Why VTV Energy"}
                </h2>
                <div className="text-white px-6" style={{ fontSize: '18px', lineHeight: '28px' }}>
                  {description || (
                    <>
            ...
            <div className='col-lg-6 col-md-12 col-sm-12'>
              <div className='EnergyRight'>
                <img src={image || require('../assets/images/commercial_infra.png')} alt={title || "Why VTV Energy"} className="img-premium" />
              </div>
            </div>
          </div>
        </div>
